            ...
            <div className="ps-5">
                ...
                <div className="col-6">
                    <div className="form-floating mb-3">
                        ...
                        <label htmlFor="description">Descreva em detalhes o que você precisa e onde você esta (para entregas presenciais):</label>
                    </div>
                </div>
                <div className="col-6">
                    <div className="form-floating mb-3">
                ...
                <div className="col-6">
                    <div className="form-floating mb-3">
                        <input type="number" id="goal" className="form-control" alue={request.goal} onChange={onInputChange} />
                        <label htmlFor="goal">Meta em BNB (deix em branco caso não deseje receber doação em cripto):</label>
                    </div>
                </div>
                <div className="row">
